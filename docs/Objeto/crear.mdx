...
Al ser un objeto, si solo se asigna como b = a se creara una referencia y no una copia, por lo que si cambias un valor de b tambien se cambiara en a y viseversa
